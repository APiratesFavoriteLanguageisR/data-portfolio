...
seda_data <- read.csv("./data/seda_county_long_cs_4.1 - Cali.csv")
...
# Note: PCA captures variance across counties, not individual-level inequity.
# Black students show among the lowest scores in race comparisons but load onto PC2
